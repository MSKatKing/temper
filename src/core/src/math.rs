...
pub fn lerp2_f32(a: [f32; 2], p: [f32; 4]) -> f32 {
    lerp_f32(
        a[1],
        [lerp_f32(a[0], [p[0], p[1]]), lerp_f32(a[0], [p[2], p[3]])],
    )
}
...
fn _mm256_fmadd_ps_fallback(
    ...
    if is_x86_feature_detected!("fma") {
        ...
        unsafe { x86_64::_mm256_fmadd_ps(a, b, c) }
    } else {
        x86_64::_mm256_add_ps(x86_64::_mm256_mul_ps(a, b), c)
    }
}
