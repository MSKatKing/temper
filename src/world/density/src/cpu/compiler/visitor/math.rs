...
impl_direct_visitor!(MinConstantVisitor, ConstantMin, dst, src: other);
impl_direct_visitor!(MinNoiseVisitor, NoiseMin, dst, src: other);

impl_commutative_visitor!(MaxBufferVisitor, BufferMax, other);
impl_direct_visitor!(MaxConstantVisitor, ConstantMax, dst, src: other);
impl_direct_visitor!(MaxNoiseVisitor, NoiseMax, dst, src: other);

impl_non_commutative_visitor!(SubBufferVisitor, BufferSub, other);
impl_direct_visitor!(SubConstantVisitor, ConstantSub, dst, src: other);
impl_direct_visitor!(SubNoiseVisitor, NoiseSub, dst, src: other);

impl_non_commutative_visitor!(DivBufferVisitor, BufferDiv, other);
impl_direct_visitor!(DivConstantVisitor, ConstantDiv, dst, src: other);
impl_direct_visitor!(DivNoiseVisitor, NoiseDiv, dst, src: other);
