...
impl World {
    ...
    pub fn get_block(&self, pos: BlockPos, dimension: Dimension) -> Result<BlockStateId, WorldError> {
        self
            .get_chunk(pos.chunk(), dimension)
    ...
    pub fn set_block(&self, pos: BlockPos, dimension: Dimension, block_state_id: BlockStateId) -> Result<(), WorldError> {
        self
            .get_chunk_mut(pos.chunk(), dimension)
